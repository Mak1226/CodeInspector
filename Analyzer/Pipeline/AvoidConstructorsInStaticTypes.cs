...
//        public AvoidConstructorsInStaticTypes(List<ParsedDLLFiles> dllFiles) : base(dllFiles)
//        {
...
//            // TODO : Map
//            return checkedTypes[cls] = CheckAllStatic(parsedDLLFile.mapTypeToParsedClass[parent]);
//        }
...
//        /// </summary>
//        /// <param name="dllFiles"></param>
//        protected override AnalyzerResult AnalyzeSingleDLL(ParsedDLLFiles parsedDLLFile)
//        {
//            foreach (ParsedClass cls in parsedDLLFile.classObjList)
//            {
//                if (cls.TypeObj.IsEnum || cls.TypeObj.IsInterface || cls.TypeObj.IsValueType || cls.TypeObj.IsSubclassOf(typeof(Delegate)))
